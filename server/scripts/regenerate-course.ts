...
async function main() {
  ...
  const course = await prisma.course.create({
    data: {
      ...
      description: 'Prepare for your French adventure by mastering essential travel phrases, starting with realistic conversations with flight attendants on your way to France. Our interactive audio course uses spaced repetition to help you speak confidently and naturally.',
      nativeLanguage: 'en',
      targetLanguage: 'fr',
      cefrLevel: 'A1',
