...
async function generateImageWithGoogleAI(prompt: string): Promise<Buffer> {
  ...
  const requestBody = {
    ...
    number_of_images: 1,
    aspect_ratio: '1:1',
    negative_prompt: 'blurry, low quality, distorted, cartoon, anime, illustration, painting, drawing, full body, legs, feet, multiple people, children, text, watermark, logo, hands',
