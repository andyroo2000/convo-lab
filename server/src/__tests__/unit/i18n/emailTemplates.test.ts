...
const mockTranslations: Record<string, Record<string, (params?: any) => string>> = {
  en: {
    ...
    'welcome.lexicalChunks.title': () => 'Lexical Chunks',
    'welcome.lexicalChunks.description': () => 'Learn phrases',
  ...
  ar: {
    ...
    'welcome.lexicalChunks.title': () => 'القطع المعجمية',
    'welcome.lexicalChunks.description': () => 'تعلم العبارات',
