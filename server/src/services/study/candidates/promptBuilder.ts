...
- imagePrompt must use this visual style: ${STUDY_IMAGE_PROMPT_STYLE}.
- If people appear in imagePrompt, describe them as Japanese. If a place appears, set it in Japan.
