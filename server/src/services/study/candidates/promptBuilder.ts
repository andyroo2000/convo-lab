...
import { STUDY_IMAGE_PROMPT_STYLE } from './imagePromptGuardrails.js';
...
- imagePrompt must use a ${STUDY_IMAGE_PROMPT_STYLE} style and describe a single scene only. Add "No text" as a constraint, and do not ask for a flashcard, worksheet, poster, title, caption, label, logo, sign, letters, words, or any visible text.
