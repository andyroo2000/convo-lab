...
export const STUDY_IMAGE_PROMPT_STYLE = IMAGE_PROMPT_STYLE;

export const STUDY_IMAGE_PROMPT_GUARDRAIL = `Use a ${STUDY_IMAGE_PROMPT_STYLE} style. ${IMAGE_PROMPT_IMMERSION_GUIDANCE} Scene only. No text, words, letters, captions, labels, signs, logos, watermarks, UI, flashcard layout, worksheet, poster, or title.`;
