...
const StudyBrowsePage = () => {
  ...
  if (cardActionMutation.error instanceof Error) {
    ...
    actionErrorMessage = deleteCardMutation.error.message;
  }
  ...
  return (
    <>
                ...
                onChange={(event) =>
                  setQuery((current) => ({
                    ...
                    queueState: (event.target.value ||
                      undefined) as StudyBrowserQuery['queueState'],
                    cursor: undefined,
                  }))
                }
                className="block w-full rounded-xl border border-gray-300 bg-white px-3 py-3 text-sm text-gray-700"
            ...
            >
              <select
                ...
                onChange={(event) =>
                  setQuery((current) => ({
                    ...current,
                    sortField: event.target.value as StudyBrowserQuery['sortField'],
                    cursor: undefined,
                  }))
                }
                className="block w-full rounded-xl border border-gray-300 bg-white px-3 py-3 text-sm text-gray-700"
            ...
            >
              <select
                ...
                onChange={(event) =>
                  setQuery((current) => ({
                    ...current,
                    sortDirection: event.target.value as StudyBrowserQuery['sortDirection'],
                    cursor: undefined,
                  }))
                }
                className="block w-full rounded-xl border border-gray-300 bg-white px-3 py-3 text-sm text-gray-700"
      ...
      <ConfirmModal
        ...
        onConfirm={() => {
          runBackgroundTask(handleDeleteSelectedCard, {
            label: 'Study browse card delete',
          });
        }}
