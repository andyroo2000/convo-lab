      ...
      <div className="max-w-5xl mx-auto space-y-3">
        ...
        >
          <div className="w-32 flex-shrink-0 bg-periwinkle flex flex-col items-center justify-center py-8">
            ...
            <span className="text-sm font-bold text-white uppercase tracking-wide">Dialogue</span>
          </div>
        ...
        >
          <div className="w-32 flex-shrink-0 bg-coral flex flex-col items-center justify-center py-8">
            <Headphones className="w-12 h-12 text-white mb-2" />
            <span className="text-sm font-bold text-white uppercase tracking-wide text-center leading-tight">Audio<br/>Course</span>
          </div>
          <div className="flex-1 px-8 py-6">
            <h2 className="text-3xl font-bold text-dark-brown group-hover:text-coral transition-colors mb-2">
              Guided Audio Course
            </h2>
            <p className="text-base text-gray-600">
        ...
        >
          <div className="w-32 flex-shrink-0 bg-strawberry flex flex-col items-center justify-center py-8">
            <Sparkles className="w-12 h-12 text-white mb-2" />
            <span className="text-sm font-bold text-white uppercase tracking-wide text-center leading-tight">Narrow<br/>Listening</span>
          </div>
          <div className="flex-1 px-8 py-6">
            <h2 className="text-3xl font-bold text-dark-brown group-hover:text-strawberry transition-colors mb-2">
        ...
        >
          <div className="w-32 flex-shrink-0 bg-yellow flex flex-col items-center justify-center py-8">
            <BookOpen className="w-12 h-12 text-dark-brown mb-2" />
            <span className="text-sm font-bold text-dark-brown uppercase tracking-wide text-center leading-tight">Chunk<br/>Pack</span>
          </div>
          <div className="flex-1 px-8 py-6">
            <h2 className="text-3xl font-bold text-dark-brown group-hover:text-yellow-dark transition-colors mb-2">
              Lexical Chunk Packs
            </h2>
            <p className="text-base text-gray-600">
