...
const CATEGORIES: Array<{
  ...
  { key: 'review', label: 'Review', color: 'text-blue-700', barColor: 'bg-blue-500' },
  { key: 'create', label: 'Create', color: 'text-amber-700', barColor: 'bg-amber-500' },
  { key: 'immerse', label: 'Immerse', color: 'text-emerald-700', barColor: 'bg-emerald-500' },
  {
    key: 'conversation',
    label: 'Conversation',
  ...
  { key: 'wanikani', label: 'WaniKani', color: 'text-pink-700', barColor: 'bg-pink-500' },
];
    ...
    <>
      ...
      <div className="mt-6 overflow-x-auto pb-2">
        <div
          ...
          aria-label="Study time by period and category"
        >
    ...
    <div className="space-y-6">
      <header className="retro-paper-panel overflow-hidden p-6 sm:p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="retro-headline text-5xl text-navy">Study Rhythm</h1>
            <p className="mt-2 max-w-2xl text-gray-600">
              See where your Japanese time goes—from reviews and card making to immersion,
              conversation, and WaniKani.
            </p>
          </div>
      ...
      <section className="retro-paper-panel p-4 sm:p-6">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="retro-caps text-coral">Your time</p>
            <h2 className="retro-headline text-3xl text-navy">Study Rhythm</h2>
          </div>
          <div
        ...
        {analyticsQuery.isError ? (
          <div className="rounded-xl bg-red-50 p-5 text-red-800">
            We couldn’t load study analytics. Try refreshing the page.
          </div>
        ) : null}
      ...
      <section className="retro-paper-panel p-6">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="retro-caps text-coral">Editable</p>
            <h2 className="retro-headline text-3xl text-navy">Manual entries</h2>
          </div>
        ...
        {!sessionsQuery.isLoading && !sessionsQuery.isError && manualSessions.length === 0 ? (
          <p className="mt-4 text-gray-600">
            Timers and study time you add yourself will appear here.
          </p>
        ) : null}
            ...
            >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  aria-label={`Edit ${session.name || 'study entry'}`}
                >
                  <Pencil className="h-4 w-4" />
                </button>
                <button
                  type="button"
                  onClick={() => deleteSession.mutate(session.clientSessionId)}
                  className="rounded-lg border border-red-200 p-2 text-red-700 hover:bg-red-50"
                  aria-label={`Delete ${session.name || 'study entry'}`}
                >
