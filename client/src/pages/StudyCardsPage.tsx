      ...
      <section className="card retro-paper-panel">
        <div className="flex items-start justify-between gap-4">
          ...
          <Link
            ...
            className="grid size-11 shrink-0 place-items-center border-2 border-navy bg-navy text-white shadow-[3px_3px_0_rgba(26,178,209,0.72)] transition hover:bg-cyan hover:text-navy focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan"
          >
