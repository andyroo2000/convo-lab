    ...
    <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden">
      ...
      <div className="p-8">
        <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-4 bg-cream rounded-xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Everyday conversations at your level: Meeting Someone New, At a Café, and Making
                    Weekend Plans
                  </p>
                </div>
              </div>
          ...
          <div>
            <h3 className="text-xl font-semibold text-navy mb-4">
              How to use your sample content:
            </h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700">
                  <span className="font-semibold">
                    Look for the blue &ldquo;Sample&rdquo; badge
                  </span>{' '}
                  on content cards in your library
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-coral flex-shrink-0 mt-0.5" />
                <p className="text-gray-700">
                  <span className="font-semibold">Click any content</span> to start practicing
                  immediately
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Check className="w-5 h-5 text-coral flex-shrink-0 mt-0.5" />
                <p className="text-gray-700">
                  <span className="font-semibold">Delete sample content</span> anytime if you
                  don&apos;t need it
                </p>
              </div>
            </div>
          ...
          <div className="bg-coral-light border-l-4 border-coral p-4 rounded-lg">
            <p className="text-sm text-gray-700">
              <span className="font-semibold">Ready to create your own?</span> Use the
              &ldquo;Generate New Content&rdquo; buttons to create custom dialogues and courses
        ...
        <div className="mt-8 flex justify-end">
          <button type="button" onClick={onClose} className="btn-primary px-8 py-3">
