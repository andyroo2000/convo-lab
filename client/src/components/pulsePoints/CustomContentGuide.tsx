import { X, Sparkles, MessageSquare, Headphones, Zap } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Custom content lets you learn from topics{' '}
              <span className="font-semibold">you actually care about</span> - whether that&apos;s
              ordering coffee, discussing your hobbies, or navigating specific situations
              you&apos;ll encounter.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">
                  Start with a <span className="font-semibold">Dialogue</span>! Just paste any text
                  (even in English) and we&apos;ll create a natural conversation at your level in
                  under 2 minutes.
                </p>
              </div>
            </div>
